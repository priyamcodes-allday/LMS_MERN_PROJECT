...
export default function TeacherLayout() {
 ...
 const navLinks = [
    ...
    { name: "My Courses", path: "/teacher/courses", icon: BookIcon },
    { name: "Upload Content", path: "/teacher/upload", icon: CalendarIcon }, 
    { name: "My Students", path: "/teacher/students", icon: UsersIcon },
    { name: "Earnings", path: "/teacher/earnings", icon: ChartIcon },
